...
typedef bool (*RecTrueDataCallback)(uint16_t addr, uint16_t group_addr,DATATYPE dataType, char* recvData);
...
bool RecvHandler(uint16_t addr, uint16_t group_addr,DATATYPE dataType, char* recvData);
